...
```{r}
# for whatever reason, the above console doesn't show the space to type unless you click "start over"
```
...
```{r ex_2, exercise = TRUE, exercise.lines = 5}
```
...
```{r ex_3, exercise = TRUE, exercise.lines = 5}
```
